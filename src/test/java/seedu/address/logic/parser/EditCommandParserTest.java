...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC
                        + VALID_ADDRESS_AMY + VALID_PHONE_AMY + INVALID_NRIC_DESC,
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditPatientDescriptor descriptor = new EditPatientDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).withNric(VALID_NRIC_AMY).build();
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + NRIC_DESC_BOB;
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        descriptor = new EditPatientDescriptorBuilder().withNric(VALID_NRIC_BOB).build();
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        userInput = targetIndex.getOneBased() + INVALID_PHONE_DESC + ADDRESS_DESC_BOB
                + PHONE_DESC_BOB;
        descriptor = new EditPatientDescriptorBuilder().withPhone(VALID_PHONE_BOB)
